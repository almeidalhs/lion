	...
	<div class="portlet-body">
		<div class="row">
            ...
            <div class="hero-unit">
			  ...
			  <!--文章内容开始-->
						<div style="clear:both;padding:20px 0 10px 5px;border-bottom:#C8C8C8 dashed 1px;" >
							<div id="zoom" style="OVERFLOW-X:auto;overflow-y:hidden;">
								<P class=MsoNormal style="LINE-HEIGHT: 1.5; TEXT-ALIGN: center"><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: 24pt"> <b>    艺术节展演活动细则       </b></SPAN></P>
								<p><span style="font-size:16px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2016年 艺术节展演活动细则，如下。</span></p>
			  ...
			  <p></p>
			  <p>
			    <a class="btn btn-primary btn-large" href="${base}/showUserSign/index.htm">
			     	 我要报名
			    </a>
			  </p>
			</div>
