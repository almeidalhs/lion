...
<!-- tasks -->
<script src="${base}/resources/admin/scripts/system/admintheatreusersign.js" type="text/javascript"></script>
</head>
...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-12">
				  <table class="lion-datagrids table table-striped table-bordered table-hover" id="sys_admintheatreuserSign_tb" data-singleselect="true",   data-loadUrl="${base}/admintheatreuserSign/list.json" data-checkbox="true" data-pageSize="30">
					<thead>
						<tr>
							<th class="table-checkbox" data-field='id' data-checkbox="true">
						 		<input type="checkbox" class="group-checkable" data-set="#sys_admintheatreuserSign_tb.checkboxes"  data-sortable="false" />
						 	</th>
