...
<script src="${base}/resources/admin/scripts/system/category.js" type="text/javascript"></script>
</head>
...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-12">
				 <table  id="sys_category_lists" class="easyui-treegrid" fit="false" style="height:400px;width:auto" fitColumns="true"
				data-options="
                url: '${base}/category/list.json',
                rownumbers: true,
                pagination: false,
                pageSize: 15,
                pageList: [5,10,15,30],
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="fa fa-plus"></i><span>添加比赛项目</span></h4>
			</div>
