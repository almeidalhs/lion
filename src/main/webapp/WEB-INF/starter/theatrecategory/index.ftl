...
<script src="${base}/resources/admin/scripts/system/theatrecategory.js" type="text/javascript"></script>
</head>
...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-12">
				 <table  id="sys_theatrecategory_lists" class="easyui-treegrid" fit="false" style="height:400px;width:auto" fitColumns="true"
				data-options="
                url: '${base}/theatrecategory/list.json',
                rownumbers: true,
                pagination: false,
                pageSize: 15,
                pageList: [5,10,15,30],
