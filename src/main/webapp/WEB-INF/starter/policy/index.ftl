		...
		<div class="row">
			<div class="col-md-12 margin-bottom-10">
				<form id="queryform" class="form-horizontal">
					...
					<div class="col-md-2">
						<input class="form-control input-small" type="text" size="30" name="policyType" id="policyType"  placeholder="<@spring.message "sys.policy.html.tip.policyType"/>"  />					
					</div>
			...
			<div class="col-md-12">
				  <table class="lion-datagrids table table-striped table-bordered table-hover" id="sys_policy_tb" data-singleselect="true",   data-loadUrl="${base}/policy/list.json" data-checkbox="true" data-pageSize="10">
					<thead>
						<tr>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<i class="fa fa-plus"></i> 
					<span>
						<@spring.message "sys.policy.form.adddialog.text"/>
					</span>
				</h4>
			</div>
												...
												<div class="form-group">
													...
													<div class="col-md-5">
														<div class="input-group">
															<input type="text"  name="policyType"  maxlength="100" class="form-control" placeholder="<@spring.message "sys.policy.html.policyType"/>" size="30"/>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-5">
														<div class="input-group">
															<input type="text"  id="insuredName" name="insuredName" maxlength="100" class="form-control" placeholder="<@spring.message "sys.policy.html.pinsuredName"/>" size="30"/>
														</div>
													</div>
												</div>
