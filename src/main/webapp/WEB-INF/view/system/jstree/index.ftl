...
<head> 
<title>jstree</title>
<link rel="stylesheet" href="${base}/resources/admin/scripts/jstree/style.min.css" />
<link href="${base}/resources/global/css/jstree/jstree.css" rel="stylesheet" type="text/css" />
...
<!-- jstree -->
<script src="${base}/resources/admin/scripts/jstree/jstree.min.js" type="text/javascript"></script>
<script src="${base}/resources/admin/scripts/jstree/jstree.contextmenu.js" type="text/javascript"></script>
<script src="${base}/resources/admin/scripts/jstree/jstree.js" type="text/javascript"></script>

</head>
<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo">

<div class="jstree_tree">
<div calss="jstree_2">
<h1>AJAX demo</h1>
