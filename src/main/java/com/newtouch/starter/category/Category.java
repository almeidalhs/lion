package com.newtouch.starter.category;
...
public class Category extends VersionEntity<Long> implements Serializable {
	...
	/** 排序 */
	private List<Category> sortedChildCategory;
	...
	@Transient
	public List<Category> getSortedChildCategory() {
		return sortedChildCategory;
	}
	public void setSortedChildCategory(List<Category> sortedChildCategory) {
