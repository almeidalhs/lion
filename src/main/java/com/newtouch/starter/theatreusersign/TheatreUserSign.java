package com.newtouch.starter.theatreusersign;
...
public class TheatreUserSign extends VersionEntity<Long> implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -1066166467434105664L;
	/**
	 * 
	 */
